...
let Cart: React.FC = () => {
    ...
    let {totalCount, totalPrice, items} = useSelector((state: any) => state.cart)
    ...
    return <div className="container container--cart">
        <div className="cart">
            <div className="cart__top">
                ...
                <div onClick={() => dispatch(clearPizzaItems())} className="cart__clear">
            ...
            <div className="content__items">
                {
                    items.map((obj: any) => {
                        return <CartItem key={obj.id} pizzaTypes={pizzaTypes} obj={obj}/>
                    })
                }
            </div>

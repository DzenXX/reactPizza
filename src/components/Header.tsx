...
import {selectCart, selectItems} from "../redux/cart/selectors";
import {setSearchValue} from "../redux/filters/slice";
import {selectSearchValue} from "../redux/filters/types";
...
export const Header: React.FC = () => {
    ...
    useEffect(() => {
        localStorage.setItem('cart', JSON.stringify(pizzaItems))
    }, [pizzaItems])
